defmodule Ecto.ULID do
  @moduledoc """
  An Ecto Type definition for the ULID specification.

  Universally Lexicographically Sortable Identifier

  The ULID specification can be explored here: https://github.com/ulid/spec

  This module is forked from: https://github.com/TheRealReal/ecto-ulid
  And was adjusted for this implementation: https://github.com/andrielfn/pg-ulid
  """
  ...
  * `timestamp`: A Unix timestamp with millisecond precision.
  ...
  # defp decode(
  #        <<c1::8, c2::8, c3::8, c4::8, c5::8, c6::8, c7::8, c8::8, c9::8, c10::8, c11::8, c12::8, c13::8, c14::8, c15::8, c16::8, c17::8, c18::8,
  #          c19::8, c20::8, c21::8, c22::8, c23::8, c24::8, c25::8, c26::8>>
  #      ) do
  #   <<d(c1)::3, d(c2)::5, d(c3)::5, d(c4)::5, d(c5)::5, d(c6)::5, d(c7)::5, d(c8)::5, d(c9)::5, d(c10)::5, d(c11)::5, d(c12)::5, d(c13)::5, d(c14)::5,
  #     d(c15)::5, d(c16)::5, d(c17)::5, d(c18)::5, d(c19)::5, d(c20)::5, d(c21)::5, d(c22)::5, d(c23)::5, d(c24)::5, d(c25)::5, d(c26)::5>>
  # catch
  #   :error -> :error
  # else
  #   decoded -> {:ok, decoded}
